...
class PhpGd extends DouAbstract
{
    ...
    public function flip($newFile, $mode)
    {
        ...
        switch ($mode){
            case Ext_Image_Abstract::FLIP_VERTICAL:
                $srcY        = $this->_height - 1;
                $srcHeight = -$this->_height;
                break;
            case Ext_Image_Abstract::FLIP_HORIZONTAL:
                $srcX      = $this->_width - 1;
                $srcWidth = -$this->_width;
                break;
            default:
    ...
    public function _crop($newFile, $resizeWidth, $resizeHeight, $newWidth, $newHeight, $cropX, $cropY, $resize = true) 
    {
        $newFile = (null == $newFile) ? $this->_file : $newFile;
